    ...
    <div class="container">
      ...
      <div class="col-sm-6">
        ...
        <div id="tambahdata">
          ...
          <a href="insert.php" class="btn-tambah" type="button">Tambah Data Pasien</a>
        </div>
        <br></br>
      </div>
      ...
      <div id="datapatients" class="col-sm-12">
        <div id="Daftar">
              ...
              <tbody>
                ...
                <?php foreach ($pasien as $row) : ?>
                  <tr>
                    ...
                    <td> <a href="edit.php?id=<?= $row["id"]; ?>" class="btn btn-warning" type="button">Edit</a>
                      <a href="delete.php?id=<?= $row["id"]; ?>" onclick="return confirm('Apakah ingin menghapus Data?');" class="btn btn-danger" type="button">Hapus</a> </td>
                  </tr>
                  <?php $i++; ?>
                <?php endforeach; ?>
              </tbody>
