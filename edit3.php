...
$psn = query("SELECT * FROM data_rekammedis WHERE id = $id")[0];
                    ...
                    <div id="Tambah">
                        <form action="" method="post">
                            ...
                            <div class="form-group input">
                                ...
                                <input type="date" class="form-control" id="tanggal_periksa" placeholder="" name="tanggal_periksa" value="<?= $psn["tanggal_periksa"]; ?>" required>
                            </div>
                            ...
                            <div class="form-group input">
                                ...
                                <select name="nama" id="nama" class="form-control" required>
                                    <option value="<?= $psn["nama"]; ?>">- Pilih -</option>
                                    <?php
                            ...
                            <div class="form-group input">
                                ...
                                <textarea type="text" class="form-control" id="keluhan" placeholder="" name="keluhan" value="<?= $psn["keluhan"]; ?>" required></textarea>
                            </div>
                            ...
                            <div class="form-group input">
                                ...
                                <select name="dokter" id="dokter" class="form-control" required>
                                    <option value="<?= $psn["dokter"]; ?>">- Pilih -</option>
                                    <?php
                            ...
                            <div class="form-group input">
                                ...
                                <textarea type="text" class="form-control" id="diagnosa" placeholder="" name="diagnosa" value="<?= $psn["diagnosa"]; ?>" required></textarea>
                            </div>
