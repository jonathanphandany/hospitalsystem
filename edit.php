...
$psn = query("SELECT * FROM data_pasien WHERE id = $id")[0];
                    ...
                    <div id="Ubah">
                        <form action="" method="post">
                            ...
                            <div class="form-group input">
                                ...
                                <input type="text" class="form-control" id="nama_pasien" placeholder="" name="nama_pasien" value="<?= $psn["nama_pasien"]; ?>" required>
                            </div>
                            <div class="form-group input">
                            ...
                            <div class="form-group input">
                                ...
                                <input type="date" class="form-control" id="tanggal_lahir" placeholder="" name="tanggal_lahir" value="<?= $psn["tanggal_lahir"]; ?>" required>
                            </div>
                            <div class="form-group input">
                                <label for="tempat_lahir">Tempat Lahir:</label>
                                <input type="text" class="form-control" id="tempat_lahir" placeholder="" name="tempat_lahir" value="<?= $psn["tempat_lahir"]; ?>" required>
                            </div>
                            <div class="form-group input">
                            ...
                            <!-- <div class="form-group input">
                                ...
                                <input type="text" class="form-control" id="keterangan" placeholder="" name="keterangan" value="<?= $psn["keterangan"]; ?>">
                            </div> -->
