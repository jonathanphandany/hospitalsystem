                    ...
                    <div id="Tambah">
                        <form action="" method="post">
                            <div class="form-group input">
                                ...
                                <input type="text" class="form-control" id="nama_dokter" placeholder="" name="nama_dokter" required>
                            </div>
                            <div class="form-group input">
                                <label for="alamat">Spesialis:</label>
                                <input type="text" class="form-control" id="spesialis" placeholder="" name="spesialis" required>
                            </div>
                            <div class="form-group input">
                            ...
                            <div class="form-group input">
                                <label for="tempat_lahir">No. Telepon:</label>
                                <input type="text" class="form-control" id="no_telp" placeholder="" name="no_telp" required>
                            </div>
